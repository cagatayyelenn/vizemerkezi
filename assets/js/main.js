                    ...
                    <div class="relative">
                        <div id="modalInnerForm" class="bg-white p-8 md:p-12 rounded-[2.5rem] shadow-2xl border border-blue-50">
                            ...
                            <form id="globalAppForm" class="space-y-5">
                                ...
                                <div class="space-y-1.5"><label class="text-sm font-semibold text-slate-700 ml-1">Adres*</label><textarea required name="address" rows="2" placeholder="Adres bilgisi" class="w-full px-5 py-3.5 rounded-xl bg-gray-50 border border-gray-100 focus:border-blue-400 focus:bg-white outline-none transition-all resize-none disabled:opacity-50 text-black"></textarea></div>
